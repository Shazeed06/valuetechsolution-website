...
const faqs = [
  {
    ...
    a: "If you need a modern marketing website or redesign, our Website Development service is the best starting point. If you want to scale revenue rapidly, PPC Advertising and SEO Optimization drive qualified demand. For saving operational hours, AI Automation handles manual data and lead routing. In our free 20-minute discovery call, we'll recommend the exact right plan for your goals.",
  },
  {
    num: "02",
  ...
  },
  {
    ...
    a: "Website development and landing pages are typically delivered in 2 to 4 weeks. PPC advertising campaigns begin driving traffic and leads within 48 to 72 hours of launch. SEO and organic search optimizations typically compound over 60 to 90 days into sustainable high-intent traffic.",
  },
  {
    num: "04",
    numColor: "text-[#1ab9a2]",
